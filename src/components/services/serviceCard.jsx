...
export function ServiceCard() {
  return (
    ...
    //         </svg>
    //       </div>
    //       <h3 className="text-xl font-semibold text-gray-800">Payment Solution</h3>
    //     </div>
    ...
    //         </svg>
    //       </div>
    //       <h3 className="text-xl font-semibold text-gray-800">Growth Business</h3>
    //     </div>
    //     <p className="text-gray-500">
    //       Volutpat id molestie quisque lorem tristique nibh consectetur fringilla habitant odio urna.
    //     </p>
    ...
    //         </svg>
    //       </div>
    //       <h3 className="text-xl font-semibold text-gray-800">Connected People</h3>
    //     </div>
    //     <p className="text-gray-500">
    //       Volutpat id molestie quisque lorem tristique nibh consectetur fringilla habitant odio urna.
    //     </p>
